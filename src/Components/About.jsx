            ...
            <div className="row g-5">
                <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div className="d-flex flex-column">
                        <img className="img-fluid rounded w-75 align-self-end" src={img1} alt="" />
                        <img className="img-fluid rounded w-50 bg-white pt-3 pe-3" src={img2}  alt="" style={{marginTop: "-25%"}}/>
                    </div>
                </div>
